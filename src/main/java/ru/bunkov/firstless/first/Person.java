...
public class Person {
    ...
    public static class Builder{
        ...
        public Person build(){
            return new Person(this.firstName, this.lastName, this.middleName, this.country, this.address, this.phone, this.age, this.gender); //если так не сделать почему-то выводило, что все поля пустые у person. видимо так и надо)
        }
    }
